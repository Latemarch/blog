	...
	return (
		<Link to={`/projects/${project.id}`}>
			<li className="relative group mb-5 text-h1 dark:text-Dh1">
				<div className="absolute inset-0 z-0 bg-zinc-200/50 dark:bg-zinc-600/50 rounded-2xl opacity-0 group-hover:transition group-hover:scale-110  group-hover:opacity-100"></div>
